...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.surf = pygame.image.load("unnamed.png")
...
def a_treat():
    webbrowser.open("https://www.tomorrowtides.com/fish-tank.html", new=1)
...
while True:
    ...
    if P1.score >100:
        coin.image=pygame.image.load("TrueTreasurehacks.png")
        if P1.score>111:
            openB=False
