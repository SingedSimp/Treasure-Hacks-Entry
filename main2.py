...
while True:
    ...
    print(score)
    if score.lower() == "up":
        win32api.SendMessage(hwndChild, win32con.WM_CHAR, 0x26, 0)
    elif score.lower() == "left":
        win32api.SendMessage(hwndChild, win32con.WM_CHAR, 0x25, 0)
    elif score.lower() == "right":
        win32api.SendMessage(hwndChild, win32con.WM_CHAR, 0x27, 0)